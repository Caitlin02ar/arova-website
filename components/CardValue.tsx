...
export default function CardValue(){
    ...
    return(
        <section className="flex items-center justify-center gap-8 items-stretch font-heading p-32 w-full">
            <div className="square w-full max-w-xs p-16 flex flex-col items-center bg-[var(--color-cream-1)] gap-12 hover:bg-[var(--color-mint-green)] transition-colors duration-300">
